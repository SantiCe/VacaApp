...
public abstract class TiltDetectingActivity extends Activity implements SensorEventListener {
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        else if (event.sensor.getType() == Sensor.TYPE_MAGNETIC_FIELD)
        {
            ...
            if (isTiltDownward())
            {
                Log.d("SCTilt","Recognized downard tilt." );
                tiltedDownward();
            }
            else if (isTiltUpward())
            {
                Log.d("SCTilt","Recognized upward tilt.");
                tiltedUpward();
            }
        }
    ...
    public abstract void tiltedUpward();
    ...
    public abstract void tiltedDownward();
...
// Taken from://www.ahotbrew.com/how-to-detect-forward-and-backward-tilt
